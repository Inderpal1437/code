...
void Encrypt(string text, int depth)
{
	...
	for(int i=0;i<len;i++) 
	{
	 ...
	 cout<<"\n\n -> The Cipher text After Caeser and Rail Fence Cipher :  "<<ciphertext<<"\n";
}
...
void Decrypt(string text, int depth)
{
	...
	cout<<"\n\n -> The Plain text After Caeser and Rail Fence Cipher : "<<plaintext<<"\n";		
}
	...
	do
	{
		...
		switch(choice)
		{
			case 1 : {
						 ...
						 cout<<"\n Caeser Cipher Encryption successful. !!!!!";
						 cout<<"\n\n -> Cipher Text After only Caeser Cipher : "<<text;
						 
						 cout<<"\n\n\n 		 ||||    Second Rail Fence Transposition    |||| "; 
						 cout<<"\n\n Enter the Depth : ";
						 cin>>depth;
						 Encrypt(text,depth);
						 break;
			...
			case 2 : {
						 ...
						 cout<<"\n Caeser Cipher Decryption successful. !!!!!";
						 cout<<"\n\n -> Plain Text After Caeser Cipher : "<<text;
						 cout<<"\n\n\n 		 ||||    Second Rail Fence Transposition    |||| "; 
						 cout<<"\n\n Enter the Depth : ";
						 cin>>depth;
						 Decrypt(text,depth);
